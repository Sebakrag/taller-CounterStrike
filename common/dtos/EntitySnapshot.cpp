...
EntitySnapshot::EntitySnapshot(const ServerEntityID id, const EntityType entt_type,
                               ...
                               const Weapon equippedWeapon, const Team team,
        ...
        angle(angle),
        is_alive(alive),
        data(PlayerSnapshot{hp, money, state, equipped_weapon_id, equippedWeapon, team,
                            weapon_type}) {
...
EntitySnapshot::EntitySnapshot(ServerEntityID id, EntityType entt_type, SpriteType sprite,
        ...
        angle(angle),
        is_alive(alive),
        data(PlayerSnapshot{0, 0, state, equipped_weapon_id, equippedWeapon, team, weapon_type}) {
    if (entt_type != EntityType::PLAYER) {
