...
void JoinGameDialog::onCancel() { done(Cancel); }

void JoinGameDialog::onRefreshGameList() { updateGameList(); }
...
QString JoinGameDialog::getSelectedGame() const { return selectedGame; }
