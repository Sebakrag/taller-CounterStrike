...
private:
    static std::shared_ptr<Texture> stencil;
...
public:
    ...
    ///
    static void init(Renderer& ren, int screenW, int screenH, float circleRadius, float fovAngleDegrees, uint8_t stencilAlpha, float fovVisibleDistance = 0);
